            ...
            function() {
                ...
                async function h(e) {
                    ...
                    let n = new URL(i.src),
                        a = n.pathname.split("/"),
                        o = a.pop();
                    return o && a.push("flags", o), n.pathname = a.join("/"),
                ...
                let k = e(),
                    S = () => {
                        ...
                        window.va = function(e, t) {
                            "beforeSend" === e ? a = t : "event" === e ? t && y(t.name, t.data, t.options) : "pageview" === e && t && (t.route && (c = t.route), t.path && (p = t.path), w({
                                withReferrer: f
                            }), f = !1), "enableCookie" === e && g()
