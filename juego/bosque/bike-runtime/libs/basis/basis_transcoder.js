var BASIS = (() => {
    ...
    return (
        function(moduleArg = {}) {
            ...
            var Emval = {
                ...
                toHandle: value => {
                    switch (value) {
                        ...
                        default:
                            {
                                const handle = emval_freelist.pop() || emval_handles.length;emval_handles[handle] = value;emval_handles[handle + 1] = 1;
                                return handle
                            }
                    }
                }
            ...
            var dynCall_jiji = Module["dynCall_jiji"] = (a0, a1, a2, a3, a4) => (dynCall_jiji = Module["dynCall_jiji"] = wasmExports["S"])(a0, a1, a2, a3, a4);
            var calledRun;
